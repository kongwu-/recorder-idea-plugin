package com.github.kongwu.recorder.plugin.agent.interceptor;

import com.alibaba.bytekit.asm.binding.Binding;
import com.alibaba.bytekit.asm.interceptor.annotation.*;
import com.github.kongwu.recorder.plugin.agent.enhance.SpyAPI;
...
//
    ...
    public static class SpyTraceExcludeJDKInterceptor1 {
        @AtInvoke(name = "", inline = true, whenComplete = false, excludes = {"com.github.kongwu.recorder.plugin.agent.enhance.SpyAPI","java.**"})
    ...
    public static class SpyTraceExcludeJDKInterceptor2 {
        @AtInvoke(name = "", inline = true, whenComplete = true, excludes = {"com.github.kongwu.recorder.plugin.agent.enhance.SpyAPI","java.**"})
        public static void onInvokeAfter(@Binding.This Object target, @Binding.Class Class<?> clazz,
                @Binding.InvokeInfo String invokeInfo) {
            SpyAPI.atAfterInvoke(clazz, invokeInfo, target);
        }
    ...
    public static class SpyTraceExcludeJDKInterceptor3 {
        @AtInvokeException(name = "", inline = true, excludes = {"com.github.kongwu.recorder.plugin.agent.enhance.SpyAPI","java.**"})
        public static void onInvokeException(@Binding.This Object target, @Binding.Class Class<?> clazz,
                @Binding.InvokeInfo String invokeInfo, @Binding.Throwable Throwable throwable,@Binding.Line int line,@Binding.InvokeMethodOwner String owner) {
            SpyAPI.atInvokeException(clazz, invokeInfo, target, throwable);
        }
    }
