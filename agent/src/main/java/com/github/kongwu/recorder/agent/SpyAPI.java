...
public class SpyAPI {
    ...
    public static abstract class AbstractSpy {
        public abstract void atEnter(Class<?> clazz, String methodName, String methodInfo, Object target,
                                     Object[] args);
    ...
    static class NopSpy extends AbstractSpy {
        ...
        @Override
        public void atEnter(Class<?> clazz, String methodName, String methodInfo, Object target, Object[] args) {
        }
